            ...
            <div class="card-body p-4">
                ...
                <div class="text-center mt-4">
                    <p class="text-muted small">
                        Demo login - 
                        <button type="button" class="btn btn-link btn-sm p-0" onclick="document.getElementById('username').value='admin'; document.getElementById('password').value='admin123';">
                            Admin User
                        </button>
                        or
                        <button type="button" class="btn btn-link btn-sm p-0" onclick="document.getElementById('username').value='staff'; document.getElementById('password').value='staff123';">
                            Staff User
                        </button>
                    </p>
                </div>
